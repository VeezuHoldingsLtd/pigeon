...
## Unreleased (Veezu fork)

**Fixed**

- FCM responses whose body is not JSON no longer raise `Jason.DecodeError`.
  The notification comes back with `:invalid_json` instead, and `:error`
  carries the decode reason and raw body.
